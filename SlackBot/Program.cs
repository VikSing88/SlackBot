...
namespace SlackBot
{
    class SlackBot
    {
        ...
        public static class IConversationsApiExtension
        {
            public static ThreadDTO GetThread(this IConversationsApi conversation, string messageTimestamp, string channel)
            {
                IConversationsApi.Replies();
        ...
        public static class IChatApiExtension
        {
            public static void PostEphemeralMessageToUser(this IChatApi chat, string message, string userId, string channelId)
            {
        ...
        public static class IUsersApiExtension
        {
