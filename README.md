...
Бот для Slack, который умеет отпинивать неактивные закрепленные сообщения спустя заданный промежуток дней, умеет пинить новые сообщения и приветсвовать пользователя, каналы для которых нужно пинить новые сообщения и приветвия можно убрать или изменить в конфигурационном фалйе. Также бот может скачивать треды с вложениями.
...
- Channels: список каналов, в которых бот будет отпинивать неактивные сообщения:
  ...
  - AutoPinMessage: разрешение для закрепления новых сообщений.
 
  - WelcomeMessage: приветсвенное сообщение.
